         ...
         <div id="login">
              <?php
                  ...
                  if ($user->uid != 0) 
                  {
                      ...
                      echo "<a href=\"/learner-plan\">My Account</a>|";
                      echo "<a href=\"/user/logout\">Log out</a>";
                     
                  }
                  else 
                  {
                    echo "<a href=\"/user\" id=\"login-button\">Log In</a>|";
                    echo "<a href=\"/user/register\" id=\"Register-button\">Register</a>";
                  }
            ?>
          </div>
          <div id="social-block">
  ...
  <div class="clearfix"></div>
    ...
    <div id="main-wrapper"><div><div>
      ...
      <div id="content"><div><div>
        ...
        <?php if ($title): ?><h1 class="title" id="page-title"><?php if(arg(0) == 'user' && arg(1) == 'register') {
          echo "Registration Form";
        }
        else if(arg(0) == 'user' && arg(3) == 'exit_information')
        {
           echo "exit information";
        }
        else if(arg(3) == 'plan_content'){
           echo "plan content";
        }else if(arg(3) == 'learner_profile'){
          echo 'personal information';
        }else if(arg(3) == 'follow_ups'){
            echo 'follow ups';
        }
        ...
        <?php if(isset($node) && $node->nid == '74')
        { ?>
         <div class='username-thankyou rtecenter'>
    ...
    <div id="footer"><div><div>
      <?php print render($page['footer']); ?>
        <div id="social-block-2">
             <?php  $block_social1 = module_invoke('block','block_view','5'); 
           ?>  <?php print render($block_social1['content']);
          ?> 
        </div>
      <div id="copyright">&copy; The LearningHUB <?php print date('Y'); ?></div>
